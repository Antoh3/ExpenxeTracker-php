...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar bg-success">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="./rupee.jpg" class="img-responsive" alt="">
            </div>
...
?>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
            ...
            <li><a href="analysis.php"><em class="fa fa-user">&nbsp;</em> Expense Analysis</a></li>
