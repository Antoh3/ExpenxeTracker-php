	...
	<div class="main">
        <div class="form">
            <form role="form" action="" method="post" name="changepassword" onsubmit="return checkpass()">
					...
					<input  placeholder="new password" name="newpassword" type="password" value="" required="true" data-form-field="username" class="form-control display-7" id="email-formbuilder-1j">
                    <input type="password" name="confirmpassword"placeholder="Confirm password" data-form-field="password" class="form-control display-7" value="" id="password-formbuilder-1j">
                    <button class="btnn" type="submit" value="" name="submit" class="btn btn-primary">
						<em>Reset</em>
					</button>

                    
                    <p href="index.php"><a href="index.php">Login</a></p>
